class PhotobooksEditeursVfsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_photobooks_editeurs_vf.save
        format.html { redirect_to _photobooks_editeurs_vf_url(@_photobooks_editeurs_vf), notice: "Photobooks editeurs vf was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_photobooks_editeurs_vf.update(_photobooks_editeurs_vf_params)
        format.html { redirect_to _photobooks_editeurs_vf_url(@_photobooks_editeurs_vf), notice: "Photobooks editeurs vf was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _photobooks_editeurs_vfs_url, notice: "Photobooks editeurs vf was successfully destroyed." }
  ...
  private
    ...
    def _photobooks_editeurs_vf_params
      params.require(:_photobooks_editeurs_vf).permit(:name)
    end
end
