class NumeroDemissionTvsSpecialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_numero_demission_tvs_special.save
        format.html { redirect_to _numero_demission_tvs_special_url(@_numero_demission_tvs_special), notice: "Numero demission tvs special was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_numero_demission_tvs_special.update(_numero_demission_tvs_special_params)
        format.html { redirect_to _numero_demission_tvs_special_url(@_numero_demission_tvs_special), notice: "Numero demission tvs special was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _numero_demission_tvs_specials_url, notice: "Numero demission tvs special was successfully destroyed." }
  ...
  private
    ...
    def _numero_demission_tvs_special_params
      params.require(:_numero_demission_tvs_special).permit(:name)
    end
end
