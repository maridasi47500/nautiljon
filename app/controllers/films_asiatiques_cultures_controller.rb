class FilmsAsiatiquesCulturesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_culture.save
        format.html { redirect_to _films_asiatiques_culture_url(@_films_asiatiques_culture), notice: "Films asiatiques culture was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_culture.update(_films_asiatiques_culture_params)
        format.html { redirect_to _films_asiatiques_culture_url(@_films_asiatiques_culture), notice: "Films asiatiques culture was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_cultures_url, notice: "Films asiatiques culture was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_culture_params
      params.require(:_films_asiatiques_culture).permit(:name)
    end
end
