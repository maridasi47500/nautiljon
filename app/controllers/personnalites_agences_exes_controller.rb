class PersonnalitesAgencesExesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnalites_agences_ex.save
        format.html { redirect_to _personnalites_agences_ex_url(@_personnalites_agences_ex), notice: "Personnalites agences ex was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnalites_agences_ex.update(_personnalites_agences_ex_params)
        format.html { redirect_to _personnalites_agences_ex_url(@_personnalites_agences_ex), notice: "Personnalites agences ex was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _personnalites_agences_exes_url, notice: "Personnalites agences ex was successfully destroyed." }
  ...
  private
    ...
    def _personnalites_agences_ex_params
      params.require(:_personnalites_agences_ex).permit(:name)
    end
end
