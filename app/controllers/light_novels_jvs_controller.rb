class LightNovelsJvsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novels_jv.save
        format.html { redirect_to _light_novels_jv_url(@_light_novels_jv), notice: "Light novels jv was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novels_jv.update(_light_novels_jv_params)
        format.html { redirect_to _light_novels_jv_url(@_light_novels_jv), notice: "Light novels jv was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _light_novels_jvs_url, notice: "Light novels jv was successfully destroyed." }
  ...
  private
    ...
    def _light_novels_jv_params
      params.require(:_light_novels_jv).permit(:name)
    end
end
