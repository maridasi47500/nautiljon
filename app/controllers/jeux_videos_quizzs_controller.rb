class JeuxVideosQuizzsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_quizz.save
        format.html { redirect_to jeux_videos_quizz_url(@_jeux_videos_quizz), notice: "Jeux videos quizz was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_quizz.update(_jeux_videos_quizz_params)
        format.html { redirect_to jeux_videos_quizz_url(@_jeux_videos_quizz), notice: "Jeux videos quizz was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to jeux_videos_quizzs_url, notice: "Jeux videos quizz was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_quizz_params
      params.require(:jeux_videos_quizz).permit(:name)
    end
end
