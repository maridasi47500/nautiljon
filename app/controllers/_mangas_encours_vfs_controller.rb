class MangasEncoursVfsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_encours_vf.save
        format.html { redirect_to _mangas_encours_vf_url(@_mangas_encours_vf), notice: "Mangas encours vf was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_encours_vf.update(_mangas_encours_vf_params)
        format.html { redirect_to _mangas_encours_vf_url(@_mangas_encours_vf), notice: "Mangas encours vf was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_encours_vfs_url, notice: "Mangas encours vf was successfully destroyed." }
  ...
  private
    ...
    def _mangas_encours_vf_params
      params.require(:_mangas_encours_vf).permit(:name)
    end
end
