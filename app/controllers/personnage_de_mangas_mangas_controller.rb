class PersonnageDeMangasMangasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnage_de_mangas_manga.save
        format.html { redirect_to personnage_de_mangas_manga_url(@_personnage_de_mangas_manga), notice: "Personnage de mangas manga was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnage_de_mangas_manga.update(_personnage_de_mangas_manga_params)
        format.html { redirect_to personnage_de_mangas_manga_url(@_personnage_de_mangas_manga), notice: "Personnage de mangas manga was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to personnage_de_mangas_mangas_url, notice: "Personnage de mangas manga was successfully destroyed." }
  ...
  private
    ...
    def _personnage_de_mangas_manga_params
      params.require(:personnage_de_mangas_manga).permit(:name)
    end
end
