class DramasAmPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_am_plu.save
        format.html { redirect_to dramas_am_plu_url(@_dramas_am_plu), notice: "Dramas am plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_am_plu.update(_dramas_am_plu_params)
        format.html { redirect_to dramas_am_plu_url(@_dramas_am_plu), notice: "Dramas am plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dramas_am_plus_url, notice: "Dramas am plu was successfully destroyed." }
  ...
  private
    ...
    def _dramas_am_plu_params
      params.require(:dramas_am_plu).permit(:name)
    end
end
