class FilmsAsiatiquesPaysController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_pay.save
        format.html { redirect_to _films_asiatiques_pay_url(@_films_asiatiques_pay), notice: "Films asiatiques pay was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_pay.update(_films_asiatiques_pay_params)
        format.html { redirect_to _films_asiatiques_pay_url(@_films_asiatiques_pay), notice: "Films asiatiques pay was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_pays_url, notice: "Films asiatiques pay was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_pay_params
      params.require(:_films_asiatiques_pay).permit(:name)
    end
end
