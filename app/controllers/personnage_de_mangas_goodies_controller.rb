class PersonnageDeMangasGoodiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnage_de_mangas_goody.save
        format.html { redirect_to _personnage_de_mangas_goody_url(@_personnage_de_mangas_goody), notice: "Personnage de mangas goody was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnage_de_mangas_goody.update(_personnage_de_mangas_goody_params)
        format.html { redirect_to _personnage_de_mangas_goody_url(@_personnage_de_mangas_goody), notice: "Personnage de mangas goody was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _personnage_de_mangas_goodies_url, notice: "Personnage de mangas goody was successfully destroyed." }
  ...
  private
    ...
    def _personnage_de_mangas_goody_params
      params.require(:_personnage_de_mangas_goody).permit(:name)
    end
end
