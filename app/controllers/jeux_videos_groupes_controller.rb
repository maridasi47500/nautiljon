class JeuxVideosGroupesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_groupe.save
        format.html { redirect_to _jeux_videos_groupe_url(@_jeux_videos_groupe), notice: "Jeux videos groupe was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_groupe.update(_jeux_videos_groupe_params)
        format.html { redirect_to _jeux_videos_groupe_url(@_jeux_videos_groupe), notice: "Jeux videos groupe was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _jeux_videos_groupes_url, notice: "Jeux videos groupe was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_groupe_params
      params.require(:_jeux_videos_groupe).permit(:name)
    end
end
