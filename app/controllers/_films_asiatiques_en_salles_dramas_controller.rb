class FilmsAsiatiquesEnSallesDramasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_en_salles_drama.save
        format.html { redirect_to _films_asiatiques_en_salles_drama_url(@_films_asiatiques_en_salles_drama), notice: "Films asiatiques en salles drama was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_en_salles_drama.update(_films_asiatiques_en_salles_drama_params)
        format.html { redirect_to _films_asiatiques_en_salles_drama_url(@_films_asiatiques_en_salles_drama), notice: "Films asiatiques en salles drama was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_en_salles_dramas_url, notice: "Films asiatiques en salles drama was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_en_salles_drama_params
      params.require(:_films_asiatiques_en_salles_drama).permit(:name)
    end
end
