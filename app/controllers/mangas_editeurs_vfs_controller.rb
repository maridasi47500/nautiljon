class MangasEditeursVfsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_editeurs_vf.save
        format.html { redirect_to mangas_editeurs_vf_url(@_mangas_editeurs_vf), notice: "Mangas editeurs vf was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_editeurs_vf.update(_mangas_editeurs_vf_params)
        format.html { redirect_to mangas_editeurs_vf_url(@_mangas_editeurs_vf), notice: "Mangas editeurs vf was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mangas_editeurs_vfs_url, notice: "Mangas editeurs vf was successfully destroyed." }
  ...
  private
    ...
    def _mangas_editeurs_vf_params
      params.require(:mangas_editeurs_vf).permit(:name)
    end
end
