class DoujinshisJvPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_jv_plu.save
        format.html { redirect_to _doujinshis_jv_plu_url(@_doujinshis_jv_plu), notice: "Doujinshis jv plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_jv_plu.update(_doujinshis_jv_plu_params)
        format.html { redirect_to _doujinshis_jv_plu_url(@_doujinshis_jv_plu), notice: "Doujinshis jv plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _doujinshis_jv_plus_url, notice: "Doujinshis jv plu was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_jv_plu_params
      params.require(:_doujinshis_jv_plu).permit(:name)
    end
end
