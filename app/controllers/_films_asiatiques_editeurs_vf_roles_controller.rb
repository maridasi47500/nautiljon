class FilmsAsiatiquesEditeursVfRolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_editeurs_vf_role.save
        format.html { redirect_to _films_asiatiques_editeurs_vf_role_url(@_films_asiatiques_editeurs_vf_role), notice: "Films asiatiques editeurs vf role was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_editeurs_vf_role.update(_films_asiatiques_editeurs_vf_role_params)
        format.html { redirect_to _films_asiatiques_editeurs_vf_role_url(@_films_asiatiques_editeurs_vf_role), notice: "Films asiatiques editeurs vf role was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_editeurs_vf_roles_url, notice: "Films asiatiques editeurs vf role was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_editeurs_vf_role_params
      params.require(:_films_asiatiques_editeurs_vf_role).permit(:name)
    end
end
