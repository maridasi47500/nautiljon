class FilmsAsiatiquesGeneriquesPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_generiques_person.save
        format.html { redirect_to _films_asiatiques_generiques_person_url(@_films_asiatiques_generiques_person), notice: "Films asiatiques generiques person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_generiques_person.update(_films_asiatiques_generiques_person_params)
        format.html { redirect_to _films_asiatiques_generiques_person_url(@_films_asiatiques_generiques_person), notice: "Films asiatiques generiques person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_generiques_people_url, notice: "Films asiatiques generiques person was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_generiques_person_params
      params.require(:_films_asiatiques_generiques_person).permit(:name)
    end
end
