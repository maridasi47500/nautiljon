class FicheUniversPersoMangasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_fiche_univers_perso_manga.save
        format.html { redirect_to fiche_univers_perso_manga_url(@_fiche_univers_perso_manga), notice: "Fiche univers perso manga was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_fiche_univers_perso_manga.update(_fiche_univers_perso_manga_params)
        format.html { redirect_to fiche_univers_perso_manga_url(@_fiche_univers_perso_manga), notice: "Fiche univers perso manga was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to fiche_univers_perso_mangas_url, notice: "Fiche univers perso manga was successfully destroyed." }
  ...
  private
    ...
    def _fiche_univers_perso_manga_params
      params.require(:fiche_univers_perso_manga).permit(:name)
    end
end
