class MangasDramaPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_drama_plu.save
        format.html { redirect_to _mangas_drama_plu_url(@_mangas_drama_plu), notice: "Mangas drama plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_drama_plu.update(_mangas_drama_plu_params)
        format.html { redirect_to _mangas_drama_plu_url(@_mangas_drama_plu), notice: "Mangas drama plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_drama_plus_url, notice: "Mangas drama plu was successfully destroyed." }
  ...
  private
    ...
    def _mangas_drama_plu_params
      params.require(:_mangas_drama_plu).permit(:name)
    end
end
