class LivresAmPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_livres_am_plu.save
        format.html { redirect_to livres_am_plu_url(@_livres_am_plu), notice: "Livres am plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_livres_am_plu.update(_livres_am_plu_params)
        format.html { redirect_to livres_am_plu_url(@_livres_am_plu), notice: "Livres am plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to livres_am_plus_url, notice: "Livres am plu was successfully destroyed." }
  ...
  private
    ...
    def _livres_am_plu_params
      params.require(:livres_am_plu).permit(:name)
    end
end
