class DoujinshisLitteratureAsiatiquePlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_litterature_asiatique_plu.save
        format.html { redirect_to _doujinshis_litterature_asiatique_plu_url(@_doujinshis_litterature_asiatique_plu), notice: "Doujinshis litterature asiatique plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_litterature_asiatique_plu.update(_doujinshis_litterature_asiatique_plu_params)
        format.html { redirect_to _doujinshis_litterature_asiatique_plu_url(@_doujinshis_litterature_asiatique_plu), notice: "Doujinshis litterature asiatique plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _doujinshis_litterature_asiatique_plus_url, notice: "Doujinshis litterature asiatique plu was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_litterature_asiatique_plu_params
      params.require(:_doujinshis_litterature_asiatique_plu).permit(:name)
    end
end
