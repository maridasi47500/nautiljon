class FilmsAsiatiquesMangasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_manga.save
        format.html { redirect_to films_asiatiques_manga_url(@_films_asiatiques_manga), notice: "Films asiatiques manga was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_manga.update(_films_asiatiques_manga_params)
        format.html { redirect_to films_asiatiques_manga_url(@_films_asiatiques_manga), notice: "Films asiatiques manga was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_mangas_url, notice: "Films asiatiques manga was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_manga_params
      params.require(:films_asiatiques_manga).permit(:name)
    end
end
