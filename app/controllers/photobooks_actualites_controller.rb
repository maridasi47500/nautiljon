class PhotobooksActualitesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_photobooks_actualite.save
        format.html { redirect_to photobooks_actualite_url(@_photobooks_actualite), notice: "Photobooks actualite was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_photobooks_actualite.update(_photobooks_actualite_params)
        format.html { redirect_to photobooks_actualite_url(@_photobooks_actualite), notice: "Photobooks actualite was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to photobooks_actualites_url, notice: "Photobooks actualite was successfully destroyed." }
  ...
  private
    ...
    def _photobooks_actualite_params
      params.require(:photobooks_actualite).permit(:name)
    end
end
