class LightNovelsSocietePeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novels_societe_person.save
        format.html { redirect_to _light_novels_societe_person_url(@_light_novels_societe_person), notice: "Light novels societe person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novels_societe_person.update(_light_novels_societe_person_params)
        format.html { redirect_to _light_novels_societe_person_url(@_light_novels_societe_person), notice: "Light novels societe person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _light_novels_societe_people_url, notice: "Light novels societe person was successfully destroyed." }
  ...
  private
    ...
    def _light_novels_societe_person_params
      params.require(:_light_novels_societe_person).permit(:name)
    end
end
