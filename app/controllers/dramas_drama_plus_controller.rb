class DramasDramaPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_drama_plu.save
        format.html { redirect_to _dramas_drama_plu_url(@_dramas_drama_plu), notice: "Dramas drama plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_drama_plu.update(_dramas_drama_plu_params)
        format.html { redirect_to _dramas_drama_plu_url(@_dramas_drama_plu), notice: "Dramas drama plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _dramas_drama_plus_url, notice: "Dramas drama plu was successfully destroyed." }
  ...
  private
    ...
    def _dramas_drama_plu_params
      params.require(:_dramas_drama_plu).permit(:name)
    end
end
