class FilmsAsiatiquesDoujinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_doujin.save
        format.html { redirect_to _films_asiatiques_doujin_url(@_films_asiatiques_doujin), notice: "Films asiatiques doujin was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_doujin.update(_films_asiatiques_doujin_params)
        format.html { redirect_to _films_asiatiques_doujin_url(@_films_asiatiques_doujin), notice: "Films asiatiques doujin was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_doujins_url, notice: "Films asiatiques doujin was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_doujin_params
      params.require(:_films_asiatiques_doujin).permit(:name)
    end
end
