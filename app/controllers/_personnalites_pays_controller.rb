class PersonnalitesPaysController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnalites_pay.save
        format.html { redirect_to _personnalites_pay_url(@_personnalites_pay), notice: "Personnalites pay was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnalites_pay.update(_personnalites_pay_params)
        format.html { redirect_to _personnalites_pay_url(@_personnalites_pay), notice: "Personnalites pay was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _personnalites_pays_url, notice: "Personnalites pay was successfully destroyed." }
  ...
  private
    ...
    def _personnalites_pay_params
      params.require(:_personnalites_pay).permit(:name)
    end
end
