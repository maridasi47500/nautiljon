class JeuxVideosConcoursController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_concour.save
        format.html { redirect_to jeux_videos_concour_url(@_jeux_videos_concour), notice: "Jeux videos concour was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_concour.update(_jeux_videos_concour_params)
        format.html { redirect_to jeux_videos_concour_url(@_jeux_videos_concour), notice: "Jeux videos concour was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to jeux_videos_concours_url, notice: "Jeux videos concour was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_concour_params
      params.require(:jeux_videos_concour).permit(:name)
    end
end
