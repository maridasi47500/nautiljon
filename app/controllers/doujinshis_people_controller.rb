class DoujinshisPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_person.save
        format.html { redirect_to _doujinshis_person_url(@_doujinshis_person), notice: "Doujinshis person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_person.update(_doujinshis_person_params)
        format.html { redirect_to _doujinshis_person_url(@_doujinshis_person), notice: "Doujinshis person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _doujinshis_people_url, notice: "Doujinshis person was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_person_params
      params.require(:_doujinshis_person).permit(:name)
    end
end
