class FilmsAsiatiquesEnSallesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_en_salle.save
        format.html { redirect_to _films_asiatiques_en_salle_url(@_films_asiatiques_en_salle), notice: "Films asiatiques en salle was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_en_salle.update(_films_asiatiques_en_salle_params)
        format.html { redirect_to _films_asiatiques_en_salle_url(@_films_asiatiques_en_salle), notice: "Films asiatiques en salle was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_en_salles_url, notice: "Films asiatiques en salle was successfully destroyed." }
