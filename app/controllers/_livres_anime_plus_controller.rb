class LivresAnimePlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_livres_anime_plu.save
        format.html { redirect_to _livres_anime_plu_url(@_livres_anime_plu), notice: "Livres anime plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_livres_anime_plu.update(_livres_anime_plu_params)
        format.html { redirect_to _livres_anime_plu_url(@_livres_anime_plu), notice: "Livres anime plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _livres_anime_plus_url, notice: "Livres anime plu was successfully destroyed." }
  ...
  private
    ...
    def _livres_anime_plu_params
      params.require(:_livres_anime_plu).permit(:name)
    end
end
