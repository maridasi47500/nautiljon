class DramasCulturesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_culture.save
        format.html { redirect_to dramas_culture_url(@_dramas_culture), notice: "Dramas culture was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_culture.update(_dramas_culture_params)
        format.html { redirect_to dramas_culture_url(@_dramas_culture), notice: "Dramas culture was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dramas_cultures_url, notice: "Dramas culture was successfully destroyed." }
  ...
  private
    ...
    def _dramas_culture_params
      params.require(:dramas_culture).permit(:name)
    end
end
