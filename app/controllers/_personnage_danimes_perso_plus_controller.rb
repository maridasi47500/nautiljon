class PersonnageDanimesPersoPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnage_danimes_perso_plu.save
        format.html { redirect_to _personnage_danimes_perso_plu_url(@_personnage_danimes_perso_plu), notice: "Personnage danimes perso plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnage_danimes_perso_plu.update(_personnage_danimes_perso_plu_params)
        format.html { redirect_to _personnage_danimes_perso_plu_url(@_personnage_danimes_perso_plu), notice: "Personnage danimes perso plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _personnage_danimes_perso_plus_url, notice: "Personnage danimes perso plu was successfully destroyed." }
  ...
  private
    ...
    def _personnage_danimes_perso_plu_params
      params.require(:_personnage_danimes_perso_plu).permit(:name)
    end
end
