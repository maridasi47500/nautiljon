class FilmsAsiatiquesAmsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_am.save
        format.html { redirect_to films_asiatiques_am_url(@_films_asiatiques_am), notice: "Films asiatiques am was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_am.update(_films_asiatiques_am_params)
        format.html { redirect_to films_asiatiques_am_url(@_films_asiatiques_am), notice: "Films asiatiques am was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_ams_url, notice: "Films asiatiques am was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_am_params
      params.require(:films_asiatiques_am).permit(:name)
    end
end
