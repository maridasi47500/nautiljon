class DramasTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_type.save
        format.html { redirect_to dramas_type_url(@_dramas_type), notice: "Dramas type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_type.update(_dramas_type_params)
        format.html { redirect_to dramas_type_url(@_dramas_type), notice: "Dramas type was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dramas_types_url, notice: "Dramas type was successfully destroyed." }
  ...
  private
    ...
    def _dramas_type_params
      params.require(:dramas_type).permit(:name)
    end
end
