class FilmsAsiatiquesAnimesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_anime.save
        format.html { redirect_to _films_asiatiques_anime_url(@_films_asiatiques_anime), notice: "Films asiatiques anime was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_anime.update(_films_asiatiques_anime_params)
        format.html { redirect_to _films_asiatiques_anime_url(@_films_asiatiques_anime), notice: "Films asiatiques anime was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_animes_url, notice: "Films asiatiques anime was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_anime_params
      params.require(:_films_asiatiques_anime).permit(:name)
    end
end
