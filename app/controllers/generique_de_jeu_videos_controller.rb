class GeneriqueDeJeuVideosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_generique_de_jeu_video.save
        format.html { redirect_to generique_de_jeu_video_url(@_generique_de_jeu_video), notice: "Generique de jeu video was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_generique_de_jeu_video.update(_generique_de_jeu_video_params)
        format.html { redirect_to generique_de_jeu_video_url(@_generique_de_jeu_video), notice: "Generique de jeu video was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to generique_de_jeu_videos_url, notice: "Generique de jeu video was successfully destroyed." }
