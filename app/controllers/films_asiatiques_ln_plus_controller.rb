class FilmsAsiatiquesLnPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_ln_plu.save
        format.html { redirect_to films_asiatiques_ln_plu_url(@_films_asiatiques_ln_plu), notice: "Films asiatiques ln plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_ln_plu.update(_films_asiatiques_ln_plu_params)
        format.html { redirect_to films_asiatiques_ln_plu_url(@_films_asiatiques_ln_plu), notice: "Films asiatiques ln plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_ln_plus_url, notice: "Films asiatiques ln plu was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_ln_plu_params
      params.require(:films_asiatiques_ln_plu).permit(:name)
    end
end
