class DramasEmissionTvsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_emission_tv.save
        format.html { redirect_to _dramas_emission_tv_url(@_dramas_emission_tv), notice: "Dramas emission tv was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_emission_tv.update(_dramas_emission_tv_params)
        format.html { redirect_to _dramas_emission_tv_url(@_dramas_emission_tv), notice: "Dramas emission tv was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _dramas_emission_tvs_url, notice: "Dramas emission tv was successfully destroyed." }
  ...
  private
    ...
    def _dramas_emission_tv_params
      params.require(:_dramas_emission_tv).permit(:name)
    end
end
