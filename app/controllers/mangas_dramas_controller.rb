class MangasDramasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_drama.save
        format.html { redirect_to mangas_drama_url(@_mangas_drama), notice: "Mangas drama was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_drama.update(_mangas_drama_params)
        format.html { redirect_to mangas_drama_url(@_mangas_drama), notice: "Mangas drama was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mangas_dramas_url, notice: "Mangas drama was successfully destroyed." }
  ...
  private
    ...
    def _mangas_drama_params
      params.require(:mangas_drama).permit(:name)
    end
end
