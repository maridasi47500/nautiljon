class LightNovelsCulturesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novels_culture.save
        format.html { redirect_to light_novels_culture_url(@_light_novels_culture), notice: "Light novels culture was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novels_culture.update(_light_novels_culture_params)
        format.html { redirect_to light_novels_culture_url(@_light_novels_culture), notice: "Light novels culture was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to light_novels_cultures_url, notice: "Light novels culture was successfully destroyed." }
  ...
  private
    ...
    def _light_novels_culture_params
      params.require(:light_novels_culture).permit(:name)
    end
end
