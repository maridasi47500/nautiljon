class DoujinshisMangaPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_manga_plu.save
        format.html { redirect_to _doujinshis_manga_plu_url(@_doujinshis_manga_plu), notice: "Doujinshis manga plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_manga_plu.update(_doujinshis_manga_plu_params)
        format.html { redirect_to _doujinshis_manga_plu_url(@_doujinshis_manga_plu), notice: "Doujinshis manga plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _doujinshis_manga_plus_url, notice: "Doujinshis manga plu was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_manga_plu_params
      params.require(:_doujinshis_manga_plu).permit(:name)
    end
end
