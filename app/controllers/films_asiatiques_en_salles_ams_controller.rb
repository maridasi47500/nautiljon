class FilmsAsiatiquesEnSallesAmsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_en_salles_am.save
        format.html { redirect_to films_asiatiques_en_salles_am_url(@_films_asiatiques_en_salles_am), notice: "Films asiatiques en salles am was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_en_salles_am.update(_films_asiatiques_en_salles_am_params)
        format.html { redirect_to films_asiatiques_en_salles_am_url(@_films_asiatiques_en_salles_am), notice: "Films asiatiques en salles am was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_en_salles_ams_url, notice: "Films asiatiques en salles am was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_en_salles_am_params
      params.require(:films_asiatiques_en_salles_am).permit(:name)
    end
end
