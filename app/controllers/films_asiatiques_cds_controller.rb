class FilmsAsiatiquesCdsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_cd.save
        format.html { redirect_to films_asiatiques_cd_url(@_films_asiatiques_cd), notice: "Films asiatiques cd was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_cd.update(_films_asiatiques_cd_params)
        format.html { redirect_to films_asiatiques_cd_url(@_films_asiatiques_cd), notice: "Films asiatiques cd was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_cds_url, notice: "Films asiatiques cd was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_cd_params
      params.require(:films_asiatiques_cd).permit(:name)
    end
end
