class FilmsAsiatiquesGeneriquesPeople2sController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_generiques_people2.save
        format.html { redirect_to films_asiatiques_generiques_people2_url(@_films_asiatiques_generiques_people2), notice: "Films asiatiques generiques people2 was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_generiques_people2.update(_films_asiatiques_generiques_people2_params)
        format.html { redirect_to films_asiatiques_generiques_people2_url(@_films_asiatiques_generiques_people2), notice: "Films asiatiques generiques people2 was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_generiques_people2s_url, notice: "Films asiatiques generiques people2 was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_generiques_people2_params
      params.require(:films_asiatiques_generiques_people2).permit(:name)
    end
end
