class LivresGroupesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_livres_groupe.save
        format.html { redirect_to _livres_groupe_url(@_livres_groupe), notice: "Livres groupe was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_livres_groupe.update(_livres_groupe_params)
        format.html { redirect_to _livres_groupe_url(@_livres_groupe), notice: "Livres groupe was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _livres_groupes_url, notice: "Livres groupe was successfully destroyed." }
  ...
  private
    ...
    def _livres_groupe_params
      params.require(:_livres_groupe).permit(:name)
    end
end
