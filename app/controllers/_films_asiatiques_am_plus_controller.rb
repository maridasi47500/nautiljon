class FilmsAsiatiquesAmPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_am_plu.save
        format.html { redirect_to _films_asiatiques_am_plu_url(@_films_asiatiques_am_plu), notice: "Films asiatiques am plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_am_plu.update(_films_asiatiques_am_plu_params)
        format.html { redirect_to _films_asiatiques_am_plu_url(@_films_asiatiques_am_plu), notice: "Films asiatiques am plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_am_plus_url, notice: "Films asiatiques am plu was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_am_plu_params
      params.require(:_films_asiatiques_am_plu).permit(:name)
    end
end
