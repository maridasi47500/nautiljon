class PersonnalitesLabelsDebutsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnalites_labels_debut.save
        format.html { redirect_to personnalites_labels_debut_url(@_personnalites_labels_debut), notice: "Personnalites labels debut was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnalites_labels_debut.update(_personnalites_labels_debut_params)
        format.html { redirect_to personnalites_labels_debut_url(@_personnalites_labels_debut), notice: "Personnalites labels debut was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to personnalites_labels_debuts_url, notice: "Personnalites labels debut was successfully destroyed." }
  ...
  private
    ...
    def _personnalites_labels_debut_params
      params.require(:personnalites_labels_debut).permit(:name)
    end
end
