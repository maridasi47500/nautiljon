class LivresMangaPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_livres_manga_plu.save
        format.html { redirect_to livres_manga_plu_url(@_livres_manga_plu), notice: "Livres manga plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_livres_manga_plu.update(_livres_manga_plu_params)
        format.html { redirect_to livres_manga_plu_url(@_livres_manga_plu), notice: "Livres manga plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to livres_manga_plus_url, notice: "Livres manga plu was successfully destroyed." }
  ...
  private
    ...
    def _livres_manga_plu_params
      params.require(:livres_manga_plu).permit(:name)
    end
end
