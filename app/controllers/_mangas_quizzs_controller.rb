class MangasQuizzsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_quizz.save
        format.html { redirect_to _mangas_quizz_url(@_mangas_quizz), notice: "Mangas quizz was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_quizz.update(_mangas_quizz_params)
        format.html { redirect_to _mangas_quizz_url(@_mangas_quizz), notice: "Mangas quizz was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_quizzs_url, notice: "Mangas quizz was successfully destroyed." }
  ...
  private
    ...
    def _mangas_quizz_params
      params.require(:_mangas_quizz).permit(:name)
    end
end
