class FilmsAsiatiquesCinemasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_cinema.save
        format.html { redirect_to _films_asiatiques_cinema_url(@_films_asiatiques_cinema), notice: "Films asiatiques cinema was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_cinema.update(_films_asiatiques_cinema_params)
        format.html { redirect_to _films_asiatiques_cinema_url(@_films_asiatiques_cinema), notice: "Films asiatiques cinema was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_cinemas_url, notice: "Films asiatiques cinema was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_cinema_params
      params.require(:_films_asiatiques_cinema).permit(:name)
    end
end
