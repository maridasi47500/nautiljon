class DoujinshisGratuitsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_gratuit.save
        format.html { redirect_to _doujinshis_gratuit_url(@_doujinshis_gratuit), notice: "Doujinshis gratuit was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_gratuit.update(_doujinshis_gratuit_params)
        format.html { redirect_to _doujinshis_gratuit_url(@_doujinshis_gratuit), notice: "Doujinshis gratuit was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _doujinshis_gratuits_url, notice: "Doujinshis gratuit was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_gratuit_params
      params.require(:_doujinshis_gratuit).permit(:name)
    end
end
