class GoodiesStaffPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_goodies_staff_person.save
        format.html { redirect_to _goodies_staff_person_url(@_goodies_staff_person), notice: "Goodies staff person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_goodies_staff_person.update(_goodies_staff_person_params)
        format.html { redirect_to _goodies_staff_person_url(@_goodies_staff_person), notice: "Goodies staff person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _goodies_staff_people_url, notice: "Goodies staff person was successfully destroyed." }
  ...
  private
    ...
    def _goodies_staff_person_params
      params.require(:_goodies_staff_person).permit(:name)
    end
end
