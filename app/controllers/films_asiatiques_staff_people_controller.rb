class FilmsAsiatiquesStaffPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_staff_person.save
        format.html { redirect_to films_asiatiques_staff_person_url(@_films_asiatiques_staff_person), notice: "Films asiatiques staff person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_staff_person.update(_films_asiatiques_staff_person_params)
        format.html { redirect_to films_asiatiques_staff_person_url(@_films_asiatiques_staff_person), notice: "Films asiatiques staff person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_staff_people_url, notice: "Films asiatiques staff person was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_staff_person_params
      params.require(:films_asiatiques_staff_person).permit(:name)
    end
end
