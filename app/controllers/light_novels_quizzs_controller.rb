class LightNovelsQuizzsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novels_quizz.save
        format.html { redirect_to light_novels_quizz_url(@_light_novels_quizz), notice: "Light novels quizz was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novels_quizz.update(_light_novels_quizz_params)
        format.html { redirect_to light_novels_quizz_url(@_light_novels_quizz), notice: "Light novels quizz was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to light_novels_quizzs_url, notice: "Light novels quizz was successfully destroyed." }
  ...
  private
    ...
    def _light_novels_quizz_params
      params.require(:light_novels_quizz).permit(:name)
    end
end
