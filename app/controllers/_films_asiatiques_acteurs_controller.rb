class FilmsAsiatiquesActeursController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_acteur.save
        format.html { redirect_to _films_asiatiques_acteur_url(@_films_asiatiques_acteur), notice: "Films asiatiques acteur was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_acteur.update(_films_asiatiques_acteur_params)
        format.html { redirect_to _films_asiatiques_acteur_url(@_films_asiatiques_acteur), notice: "Films asiatiques acteur was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_acteurs_url, notice: "Films asiatiques acteur was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_acteur_params
      params.require(:_films_asiatiques_acteur).permit(:name)
    end
end
