class GoodiesPaysController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_goodies_pay.save
        format.html { redirect_to _goodies_pay_url(@_goodies_pay), notice: "Goodies pay was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_goodies_pay.update(_goodies_pay_params)
        format.html { redirect_to _goodies_pay_url(@_goodies_pay), notice: "Goodies pay was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _goodies_pays_url, notice: "Goodies pay was successfully destroyed." }
  ...
  private
    ...
    def _goodies_pay_params
      params.require(:_goodies_pay).permit(:name)
    end
end
