class ParolesStaffPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_paroles_staff_person.save
        format.html { redirect_to _paroles_staff_person_url(@_paroles_staff_person), notice: "Paroles staff person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_paroles_staff_person.update(_paroles_staff_person_params)
        format.html { redirect_to _paroles_staff_person_url(@_paroles_staff_person), notice: "Paroles staff person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _paroles_staff_people_url, notice: "Paroles staff person was successfully destroyed." }
  ...
  private
    ...
    def _paroles_staff_person_params
      params.require(:_paroles_staff_person).permit(:name)
    end
end
