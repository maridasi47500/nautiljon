class MangasAnimePlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_anime_plu.save
        format.html { redirect_to mangas_anime_plu_url(@_mangas_anime_plu), notice: "Mangas anime plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_anime_plu.update(_mangas_anime_plu_params)
        format.html { redirect_to mangas_anime_plu_url(@_mangas_anime_plu), notice: "Mangas anime plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mangas_anime_plus_url, notice: "Mangas anime plu was successfully destroyed." }
  ...
  private
    ...
    def _mangas_anime_plu_params
      params.require(:mangas_anime_plu).permit(:name)
    end
end
