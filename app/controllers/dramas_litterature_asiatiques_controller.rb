class DramasLitteratureAsiatiquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_litterature_asiatique.save
        format.html { redirect_to _dramas_litterature_asiatique_url(@_dramas_litterature_asiatique), notice: "Dramas litterature asiatique was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_litterature_asiatique.update(_dramas_litterature_asiatique_params)
        format.html { redirect_to _dramas_litterature_asiatique_url(@_dramas_litterature_asiatique), notice: "Dramas litterature asiatique was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _dramas_litterature_asiatiques_url, notice: "Dramas litterature asiatique was successfully destroyed." }
  ...
  private
    ...
    def _dramas_litterature_asiatique_params
      params.require(:_dramas_litterature_asiatique).permit(:name)
    end
end
