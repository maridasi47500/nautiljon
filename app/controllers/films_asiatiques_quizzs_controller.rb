class FilmsAsiatiquesQuizzsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_quizz.save
        format.html { redirect_to films_asiatiques_quizz_url(@_films_asiatiques_quizz), notice: "Films asiatiques quizz was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_quizz.update(_films_asiatiques_quizz_params)
        format.html { redirect_to films_asiatiques_quizz_url(@_films_asiatiques_quizz), notice: "Films asiatiques quizz was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_quizzs_url, notice: "Films asiatiques quizz was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_quizz_params
      params.require(:films_asiatiques_quizz).permit(:name)
    end
end
