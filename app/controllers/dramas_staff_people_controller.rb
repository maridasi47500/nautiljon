class DramasStaffPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_staff_person.save
        format.html { redirect_to dramas_staff_person_url(@_dramas_staff_person), notice: "Dramas staff person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_staff_person.update(_dramas_staff_person_params)
        format.html { redirect_to dramas_staff_person_url(@_dramas_staff_person), notice: "Dramas staff person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dramas_staff_people_url, notice: "Dramas staff person was successfully destroyed." }
  ...
  private
    ...
    def _dramas_staff_person_params
      params.require(:dramas_staff_person).permit(:name)
    end
end
