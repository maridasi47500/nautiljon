class BrevesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_brefe.save
        format.html { redirect_to _brefe_url(@_brefe), notice: "Brefe was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_brefe.update(_brefe_params)
        format.html { redirect_to _brefe_url(@_brefe), notice: "Brefe was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _breves_url, notice: "Brefe was successfully destroyed." }
