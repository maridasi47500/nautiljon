class LightNovelsOstsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novels_ost.save
        format.html { redirect_to _light_novels_ost_url(@_light_novels_ost), notice: "Light novels ost was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novels_ost.update(_light_novels_ost_params)
        format.html { redirect_to _light_novels_ost_url(@_light_novels_ost), notice: "Light novels ost was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _light_novels_osts_url, notice: "Light novels ost was successfully destroyed." }
  ...
  private
    ...
    def _light_novels_ost_params
      params.require(:_light_novels_ost).permit(:name)
    end
end
