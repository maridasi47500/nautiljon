class BrevesAmsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_breves_am.save
        format.html { redirect_to breves_am_url(@_breves_am), notice: "Breves am was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_breves_am.update(_breves_am_params)
        format.html { redirect_to breves_am_url(@_breves_am), notice: "Breves am was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to breves_ams_url, notice: "Breves am was successfully destroyed." }
  ...
  private
    ...
    def _breves_am_params
      params.require(:breves_am).permit(:name)
    end
end
