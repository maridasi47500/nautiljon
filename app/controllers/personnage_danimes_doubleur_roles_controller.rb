class PersonnageDanimesDoubleurRolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnage_danimes_doubleur_role.save
        format.html { redirect_to personnage_danimes_doubleur_role_url(@_personnage_danimes_doubleur_role), notice: "Personnage danimes doubleur role was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnage_danimes_doubleur_role.update(_personnage_danimes_doubleur_role_params)
        format.html { redirect_to personnage_danimes_doubleur_role_url(@_personnage_danimes_doubleur_role), notice: "Personnage danimes doubleur role was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to personnage_danimes_doubleur_roles_url, notice: "Personnage danimes doubleur role was successfully destroyed." }
  ...
  private
    ...
    def _personnage_danimes_doubleur_role_params
      params.require(:personnage_danimes_doubleur_role).permit(:name)
    end
end
