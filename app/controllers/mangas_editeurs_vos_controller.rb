class MangasEditeursVosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_editeurs_vo.save
        format.html { redirect_to mangas_editeurs_vo_url(@_mangas_editeurs_vo), notice: "Mangas editeurs vo was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_editeurs_vo.update(_mangas_editeurs_vo_params)
        format.html { redirect_to mangas_editeurs_vo_url(@_mangas_editeurs_vo), notice: "Mangas editeurs vo was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mangas_editeurs_vos_url, notice: "Mangas editeurs vo was successfully destroyed." }
  ...
  private
    ...
    def _mangas_editeurs_vo_params
      params.require(:mangas_editeurs_vo).permit(:name)
    end
end
