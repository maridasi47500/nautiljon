class FicheUniversActualitesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_fiche_univers_actualite.save
        format.html { redirect_to fiche_univers_actualite_url(@_fiche_univers_actualite), notice: "Fiche univers actualite was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_fiche_univers_actualite.update(_fiche_univers_actualite_params)
        format.html { redirect_to fiche_univers_actualite_url(@_fiche_univers_actualite), notice: "Fiche univers actualite was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to fiche_univers_actualites_url, notice: "Fiche univers actualite was successfully destroyed." }
  ...
  private
    ...
    def _fiche_univers_actualite_params
      params.require(:fiche_univers_actualite).permit(:name)
    end
end
