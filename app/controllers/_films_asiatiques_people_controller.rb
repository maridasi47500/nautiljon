class FilmsAsiatiquesPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_person.save
        format.html { redirect_to _films_asiatiques_person_url(@_films_asiatiques_person), notice: "Films asiatiques person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_person.update(_films_asiatiques_person_params)
        format.html { redirect_to _films_asiatiques_person_url(@_films_asiatiques_person), notice: "Films asiatiques person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_people_url, notice: "Films asiatiques person was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_person_params
      params.require(:_films_asiatiques_person).permit(:name)
    end
end
