class FilmsAsiatiquesGroupesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_groupe.save
        format.html { redirect_to _films_asiatiques_groupe_url(@_films_asiatiques_groupe), notice: "Films asiatiques groupe was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_groupe.update(_films_asiatiques_groupe_params)
        format.html { redirect_to _films_asiatiques_groupe_url(@_films_asiatiques_groupe), notice: "Films asiatiques groupe was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_groupes_url, notice: "Films asiatiques groupe was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_groupe_params
      params.require(:_films_asiatiques_groupe).permit(:name)
    end
end
