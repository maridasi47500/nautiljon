class MangasPaysController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_pay.save
        format.html { redirect_to mangas_pay_url(@_mangas_pay), notice: "Mangas pay was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_pay.update(_mangas_pay_params)
        format.html { redirect_to mangas_pay_url(@_mangas_pay), notice: "Mangas pay was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mangas_pays_url, notice: "Mangas pay was successfully destroyed." }
  ...
  private
    ...
    def _mangas_pay_params
      params.require(:mangas_pay).permit(:name)
    end
end
