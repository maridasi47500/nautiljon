class FilmsAsiatiquesGeneriquesParolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_generiques_parole.save
        format.html { redirect_to films_asiatiques_generiques_parole_url(@_films_asiatiques_generiques_parole), notice: "Films asiatiques generiques parole was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_generiques_parole.update(_films_asiatiques_generiques_parole_params)
        format.html { redirect_to films_asiatiques_generiques_parole_url(@_films_asiatiques_generiques_parole), notice: "Films asiatiques generiques parole was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_generiques_paroles_url, notice: "Films asiatiques generiques parole was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_generiques_parole_params
      params.require(:films_asiatiques_generiques_parole).permit(:name)
    end
end
