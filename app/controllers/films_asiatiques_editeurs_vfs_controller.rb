class FilmsAsiatiquesEditeursVfsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_editeurs_vf.save
        format.html { redirect_to _films_asiatiques_editeurs_vf_url(@_films_asiatiques_editeurs_vf), notice: "Films asiatiques editeurs vf was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_editeurs_vf.update(_films_asiatiques_editeurs_vf_params)
        format.html { redirect_to _films_asiatiques_editeurs_vf_url(@_films_asiatiques_editeurs_vf), notice: "Films asiatiques editeurs vf was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_editeurs_vfs_url, notice: "Films asiatiques editeurs vf was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_editeurs_vf_params
      params.require(:_films_asiatiques_editeurs_vf).permit(:name)
    end
end
