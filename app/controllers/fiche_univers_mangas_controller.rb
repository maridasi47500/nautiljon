class FicheUniversMangasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_fiche_univers_manga.save
        format.html { redirect_to _fiche_univers_manga_url(@_fiche_univers_manga), notice: "Fiche univers manga was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_fiche_univers_manga.update(_fiche_univers_manga_params)
        format.html { redirect_to _fiche_univers_manga_url(@_fiche_univers_manga), notice: "Fiche univers manga was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _fiche_univers_mangas_url, notice: "Fiche univers manga was successfully destroyed." }
  ...
  private
    ...
    def _fiche_univers_manga_params
      params.require(:_fiche_univers_manga).permit(:name)
    end
end
