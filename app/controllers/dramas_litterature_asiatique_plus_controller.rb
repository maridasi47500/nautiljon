class DramasLitteratureAsiatiquePlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_litterature_asiatique_plu.save
        format.html { redirect_to _dramas_litterature_asiatique_plu_url(@_dramas_litterature_asiatique_plu), notice: "Dramas litterature asiatique plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_litterature_asiatique_plu.update(_dramas_litterature_asiatique_plu_params)
        format.html { redirect_to _dramas_litterature_asiatique_plu_url(@_dramas_litterature_asiatique_plu), notice: "Dramas litterature asiatique plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _dramas_litterature_asiatique_plus_url, notice: "Dramas litterature asiatique plu was successfully destroyed." }
  ...
  private
    ...
    def _dramas_litterature_asiatique_plu_params
      params.require(:_dramas_litterature_asiatique_plu).permit(:name)
    end
end
