class JeuxVideosMangasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_manga.save
        format.html { redirect_to jeux_videos_manga_url(@_jeux_videos_manga), notice: "Jeux videos manga was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_manga.update(_jeux_videos_manga_params)
        format.html { redirect_to jeux_videos_manga_url(@_jeux_videos_manga), notice: "Jeux videos manga was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to jeux_videos_mangas_url, notice: "Jeux videos manga was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_manga_params
      params.require(:jeux_videos_manga).permit(:name)
    end
end
