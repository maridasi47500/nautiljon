class PersonnageDanimesPersosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnage_danimes_perso.save
        format.html { redirect_to _personnage_danimes_perso_url(@_personnage_danimes_perso), notice: "Personnage danimes perso was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnage_danimes_perso.update(_personnage_danimes_perso_params)
        format.html { redirect_to _personnage_danimes_perso_url(@_personnage_danimes_perso), notice: "Personnage danimes perso was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _personnage_danimes_persos_url, notice: "Personnage danimes perso was successfully destroyed." }
  ...
  private
    ...
    def _personnage_danimes_perso_params
      params.require(:_personnage_danimes_perso).permit(:name)
    end
end
