class DoujinshisQuizzsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_quizz.save
        format.html { redirect_to doujinshis_quizz_url(@_doujinshis_quizz), notice: "Doujinshis quizz was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_quizz.update(_doujinshis_quizz_params)
        format.html { redirect_to doujinshis_quizz_url(@_doujinshis_quizz), notice: "Doujinshis quizz was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to doujinshis_quizzs_url, notice: "Doujinshis quizz was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_quizz_params
      params.require(:doujinshis_quizz).permit(:name)
    end
end
