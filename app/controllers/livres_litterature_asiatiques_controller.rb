class LivresLitteratureAsiatiquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_livres_litterature_asiatique.save
        format.html { redirect_to _livres_litterature_asiatique_url(@_livres_litterature_asiatique), notice: "Livres litterature asiatique was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_livres_litterature_asiatique.update(_livres_litterature_asiatique_params)
        format.html { redirect_to _livres_litterature_asiatique_url(@_livres_litterature_asiatique), notice: "Livres litterature asiatique was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _livres_litterature_asiatiques_url, notice: "Livres litterature asiatique was successfully destroyed." }
  ...
  private
    ...
    def _livres_litterature_asiatique_params
      params.require(:_livres_litterature_asiatique).permit(:name)
    end
end
