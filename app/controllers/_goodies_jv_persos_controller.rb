class GoodiesJvPersosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_goodies_jv_perso.save
        format.html { redirect_to _goodies_jv_perso_url(@_goodies_jv_perso), notice: "Goodies jv perso was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_goodies_jv_perso.update(_goodies_jv_perso_params)
        format.html { redirect_to _goodies_jv_perso_url(@_goodies_jv_perso), notice: "Goodies jv perso was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _goodies_jv_persos_url, notice: "Goodies jv perso was successfully destroyed." }
  ...
  private
    ...
    def _goodies_jv_perso_params
      params.require(:_goodies_jv_perso).permit(:name)
    end
end
