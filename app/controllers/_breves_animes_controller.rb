class BrevesAnimesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_breves_anime.save
        format.html { redirect_to _breves_anime_url(@_breves_anime), notice: "Breves anime was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_breves_anime.update(_breves_anime_params)
        format.html { redirect_to _breves_anime_url(@_breves_anime), notice: "Breves anime was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _breves_animes_url, notice: "Breves anime was successfully destroyed." }
  ...
  private
    ...
    def _breves_anime_params
      params.require(:_breves_anime).permit(:name)
    end
end
