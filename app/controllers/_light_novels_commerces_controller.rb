class LightNovelsCommercesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novels_commerce.save
        format.html { redirect_to _light_novels_commerce_url(@_light_novels_commerce), notice: "Light novels commerce was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novels_commerce.update(_light_novels_commerce_params)
        format.html { redirect_to _light_novels_commerce_url(@_light_novels_commerce), notice: "Light novels commerce was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _light_novels_commerces_url, notice: "Light novels commerce was successfully destroyed." }
  ...
  private
    ...
    def _light_novels_commerce_params
      params.require(:_light_novels_commerce).permit(:name)
    end
end
