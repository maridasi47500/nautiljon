class LightNovelsMangaPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novels_manga_plu.save
        format.html { redirect_to light_novels_manga_plu_url(@_light_novels_manga_plu), notice: "Light novels manga plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novels_manga_plu.update(_light_novels_manga_plu_params)
        format.html { redirect_to light_novels_manga_plu_url(@_light_novels_manga_plu), notice: "Light novels manga plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to light_novels_manga_plus_url, notice: "Light novels manga plu was successfully destroyed." }
  ...
  private
    ...
    def _light_novels_manga_plu_params
      params.require(:light_novels_manga_plu).permit(:name)
    end
end
