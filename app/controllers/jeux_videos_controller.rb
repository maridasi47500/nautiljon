class JeuxVideosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_video.save
        format.html { redirect_to jeux_video_url(@_jeux_video), notice: "Jeux video was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_video.update(_jeux_video_params)
        format.html { redirect_to jeux_video_url(@_jeux_video), notice: "Jeux video was successfully updated." }
