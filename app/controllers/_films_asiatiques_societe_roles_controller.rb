class FilmsAsiatiquesSocieteRolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_societe_role.save
        format.html { redirect_to _films_asiatiques_societe_role_url(@_films_asiatiques_societe_role), notice: "Films asiatiques societe role was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_societe_role.update(_films_asiatiques_societe_role_params)
        format.html { redirect_to _films_asiatiques_societe_role_url(@_films_asiatiques_societe_role), notice: "Films asiatiques societe role was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_societe_roles_url, notice: "Films asiatiques societe role was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_societe_role_params
      params.require(:_films_asiatiques_societe_role).permit(:name)
    end
end
