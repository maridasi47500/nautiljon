class PersonnagesDeJeuxVideosJvPersosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnages_de_jeux_videos_jv_perso.save
        format.html { redirect_to _personnages_de_jeux_videos_jv_perso_url(@_personnages_de_jeux_videos_jv_perso), notice: "Personnages de jeux videos jv perso was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnages_de_jeux_videos_jv_perso.update(_personnages_de_jeux_videos_jv_perso_params)
        format.html { redirect_to _personnages_de_jeux_videos_jv_perso_url(@_personnages_de_jeux_videos_jv_perso), notice: "Personnages de jeux videos jv perso was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _personnages_de_jeux_videos_jv_persos_url, notice: "Personnages de jeux videos jv perso was successfully destroyed." }
  ...
  private
    ...
    def _personnages_de_jeux_videos_jv_perso_params
      params.require(:_personnages_de_jeux_videos_jv_perso).permit(:name)
    end
end
