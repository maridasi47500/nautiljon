class MangasLitteratureAsiatiquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_litterature_asiatique.save
        format.html { redirect_to _mangas_litterature_asiatique_url(@_mangas_litterature_asiatique), notice: "Mangas litterature asiatique was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_litterature_asiatique.update(_mangas_litterature_asiatique_params)
        format.html { redirect_to _mangas_litterature_asiatique_url(@_mangas_litterature_asiatique), notice: "Mangas litterature asiatique was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_litterature_asiatiques_url, notice: "Mangas litterature asiatique was successfully destroyed." }
  ...
  private
    ...
    def _mangas_litterature_asiatique_params
      params.require(:_mangas_litterature_asiatique).permit(:name)
    end
end
