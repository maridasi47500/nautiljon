class DramasAmsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_am.save
        format.html { redirect_to _dramas_am_url(@_dramas_am), notice: "Dramas am was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_am.update(_dramas_am_params)
        format.html { redirect_to _dramas_am_url(@_dramas_am), notice: "Dramas am was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _dramas_ams_url, notice: "Dramas am was successfully destroyed." }
  ...
  private
    ...
    def _dramas_am_params
      params.require(:_dramas_am).permit(:name)
    end
end
