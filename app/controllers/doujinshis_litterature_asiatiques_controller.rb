class DoujinshisLitteratureAsiatiquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_litterature_asiatique.save
        format.html { redirect_to _doujinshis_litterature_asiatique_url(@_doujinshis_litterature_asiatique), notice: "Doujinshis litterature asiatique was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_litterature_asiatique.update(_doujinshis_litterature_asiatique_params)
        format.html { redirect_to _doujinshis_litterature_asiatique_url(@_doujinshis_litterature_asiatique), notice: "Doujinshis litterature asiatique was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _doujinshis_litterature_asiatiques_url, notice: "Doujinshis litterature asiatique was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_litterature_asiatique_params
      params.require(:_doujinshis_litterature_asiatique).permit(:name)
    end
end
