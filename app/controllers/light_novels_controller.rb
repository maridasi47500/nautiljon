class LightNovelsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novel.save
        format.html { redirect_to _light_novel_url(@_light_novel), notice: "Light novel was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novel.update(_light_novel_params)
        format.html { redirect_to _light_novel_url(@_light_novel), notice: "Light novel was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _light_novels_url, notice: "Light novel was successfully destroyed." }
