class FicheUniversJvPersosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_fiche_univers_jv_perso.save
        format.html { redirect_to _fiche_univers_jv_perso_url(@_fiche_univers_jv_perso), notice: "Fiche univers jv perso was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_fiche_univers_jv_perso.update(_fiche_univers_jv_perso_params)
        format.html { redirect_to _fiche_univers_jv_perso_url(@_fiche_univers_jv_perso), notice: "Fiche univers jv perso was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _fiche_univers_jv_persos_url, notice: "Fiche univers jv perso was successfully destroyed." }
  ...
  private
    ...
    def _fiche_univers_jv_perso_params
      params.require(:_fiche_univers_jv_perso).permit(:name)
    end
end
