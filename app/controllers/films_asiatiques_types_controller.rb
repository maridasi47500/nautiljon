class FilmsAsiatiquesTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_type.save
        format.html { redirect_to films_asiatiques_type_url(@_films_asiatiques_type), notice: "Films asiatiques type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_type.update(_films_asiatiques_type_params)
        format.html { redirect_to films_asiatiques_type_url(@_films_asiatiques_type), notice: "Films asiatiques type was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_types_url, notice: "Films asiatiques type was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_type_params
      params.require(:films_asiatiques_type).permit(:name)
    end
end
