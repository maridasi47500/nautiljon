class PersonnalitesLabelsFinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnalites_labels_fin.save
        format.html { redirect_to personnalites_labels_fin_url(@_personnalites_labels_fin), notice: "Personnalites labels fin was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnalites_labels_fin.update(_personnalites_labels_fin_params)
        format.html { redirect_to personnalites_labels_fin_url(@_personnalites_labels_fin), notice: "Personnalites labels fin was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to personnalites_labels_fins_url, notice: "Personnalites labels fin was successfully destroyed." }
  ...
  private
    ...
    def _personnalites_labels_fin_params
      params.require(:personnalites_labels_fin).permit(:name)
    end
end
