class DoujinshisStaffPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_staff_person.save
        format.html { redirect_to _doujinshis_staff_person_url(@_doujinshis_staff_person), notice: "Doujinshis staff person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_staff_person.update(_doujinshis_staff_person_params)
        format.html { redirect_to _doujinshis_staff_person_url(@_doujinshis_staff_person), notice: "Doujinshis staff person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _doujinshis_staff_people_url, notice: "Doujinshis staff person was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_staff_person_params
      params.require(:_doujinshis_staff_person).permit(:name)
    end
end
