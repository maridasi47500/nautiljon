class DramasAnimePlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_anime_plu.save
        format.html { redirect_to dramas_anime_plu_url(@_dramas_anime_plu), notice: "Dramas anime plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_anime_plu.update(_dramas_anime_plu_params)
        format.html { redirect_to dramas_anime_plu_url(@_dramas_anime_plu), notice: "Dramas anime plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dramas_anime_plus_url, notice: "Dramas anime plu was successfully destroyed." }
  ...
  private
    ...
    def _dramas_anime_plu_params
      params.require(:dramas_anime_plu).permit(:name)
    end
end
