class LivresJvPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_livres_jv_plu.save
        format.html { redirect_to livres_jv_plu_url(@_livres_jv_plu), notice: "Livres jv plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_livres_jv_plu.update(_livres_jv_plu_params)
        format.html { redirect_to livres_jv_plu_url(@_livres_jv_plu), notice: "Livres jv plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to livres_jv_plus_url, notice: "Livres jv plu was successfully destroyed." }
  ...
  private
    ...
    def _livres_jv_plu_params
      params.require(:livres_jv_plu).permit(:name)
    end
end
