class MangasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_manga.save
        format.html { redirect_to _manga_url(@_manga), notice: "Manga was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_manga.update(_manga_params)
        format.html { redirect_to _manga_url(@_manga), notice: "Manga was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_url, notice: "Manga was successfully destroyed." }
