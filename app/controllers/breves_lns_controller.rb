class BrevesLnsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_breves_ln.save
        format.html { redirect_to _breves_ln_url(@_breves_ln), notice: "Breves ln was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_breves_ln.update(_breves_ln_params)
        format.html { redirect_to _breves_ln_url(@_breves_ln), notice: "Breves ln was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _breves_lns_url, notice: "Breves ln was successfully destroyed." }
  ...
  private
    ...
    def _breves_ln_params
      params.require(:_breves_ln).permit(:name)
    end
end
