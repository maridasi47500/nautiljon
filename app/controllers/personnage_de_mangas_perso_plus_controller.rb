class PersonnageDeMangasPersoPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnage_de_mangas_perso_plu.save
        format.html { redirect_to personnage_de_mangas_perso_plu_url(@_personnage_de_mangas_perso_plu), notice: "Personnage de mangas perso plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnage_de_mangas_perso_plu.update(_personnage_de_mangas_perso_plu_params)
        format.html { redirect_to personnage_de_mangas_perso_plu_url(@_personnage_de_mangas_perso_plu), notice: "Personnage de mangas perso plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to personnage_de_mangas_perso_plus_url, notice: "Personnage de mangas perso plu was successfully destroyed." }
  ...
  private
    ...
    def _personnage_de_mangas_perso_plu_params
      params.require(:personnage_de_mangas_perso_plu).permit(:name)
    end
end
