class DoujinshisPersoMangasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_perso_manga.save
        format.html { redirect_to _doujinshis_perso_manga_url(@_doujinshis_perso_manga), notice: "Doujinshis perso manga was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_perso_manga.update(_doujinshis_perso_manga_params)
        format.html { redirect_to _doujinshis_perso_manga_url(@_doujinshis_perso_manga), notice: "Doujinshis perso manga was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _doujinshis_perso_mangas_url, notice: "Doujinshis perso manga was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_perso_manga_params
      params.require(:_doujinshis_perso_manga).permit(:name)
    end
end
