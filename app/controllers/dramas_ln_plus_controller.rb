class DramasLnPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_ln_plu.save
        format.html { redirect_to dramas_ln_plu_url(@_dramas_ln_plu), notice: "Dramas ln plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_ln_plu.update(_dramas_ln_plu_params)
        format.html { redirect_to dramas_ln_plu_url(@_dramas_ln_plu), notice: "Dramas ln plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dramas_ln_plus_url, notice: "Dramas ln plu was successfully destroyed." }
  ...
  private
    ...
    def _dramas_ln_plu_params
      params.require(:dramas_ln_plu).permit(:name)
    end
end
