class DramasStaffRolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_staff_role.save
        format.html { redirect_to _dramas_staff_role_url(@_dramas_staff_role), notice: "Dramas staff role was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_staff_role.update(_dramas_staff_role_params)
        format.html { redirect_to _dramas_staff_role_url(@_dramas_staff_role), notice: "Dramas staff role was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _dramas_staff_roles_url, notice: "Dramas staff role was successfully destroyed." }
  ...
  private
    ...
    def _dramas_staff_role_params
      params.require(:_dramas_staff_role).permit(:name)
    end
end
