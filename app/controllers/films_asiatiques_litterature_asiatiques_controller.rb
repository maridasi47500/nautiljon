class FilmsAsiatiquesLitteratureAsiatiquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_litterature_asiatique.save
        format.html { redirect_to films_asiatiques_litterature_asiatique_url(@_films_asiatiques_litterature_asiatique), notice: "Films asiatiques litterature asiatique was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_litterature_asiatique.update(_films_asiatiques_litterature_asiatique_params)
        format.html { redirect_to films_asiatiques_litterature_asiatique_url(@_films_asiatiques_litterature_asiatique), notice: "Films asiatiques litterature asiatique was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_litterature_asiatiques_url, notice: "Films asiatiques litterature asiatique was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_litterature_asiatique_params
      params.require(:films_asiatiques_litterature_asiatique).permit(:name)
    end
end
