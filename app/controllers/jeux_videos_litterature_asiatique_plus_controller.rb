class JeuxVideosLitteratureAsiatiquePlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_litterature_asiatique_plu.save
        format.html { redirect_to _jeux_videos_litterature_asiatique_plu_url(@_jeux_videos_litterature_asiatique_plu), notice: "Jeux videos litterature asiatique plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_litterature_asiatique_plu.update(_jeux_videos_litterature_asiatique_plu_params)
        format.html { redirect_to _jeux_videos_litterature_asiatique_plu_url(@_jeux_videos_litterature_asiatique_plu), notice: "Jeux videos litterature asiatique plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _jeux_videos_litterature_asiatique_plus_url, notice: "Jeux videos litterature asiatique plu was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_litterature_asiatique_plu_params
      params.require(:_jeux_videos_litterature_asiatique_plu).permit(:name)
    end
end
