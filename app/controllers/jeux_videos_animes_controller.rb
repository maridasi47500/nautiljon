class JeuxVideosAnimesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_anime.save
        format.html { redirect_to jeux_videos_anime_url(@_jeux_videos_anime), notice: "Jeux videos anime was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_anime.update(_jeux_videos_anime_params)
        format.html { redirect_to jeux_videos_anime_url(@_jeux_videos_anime), notice: "Jeux videos anime was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to jeux_videos_animes_url, notice: "Jeux videos anime was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_anime_params
      params.require(:jeux_videos_anime).permit(:name)
    end
end
