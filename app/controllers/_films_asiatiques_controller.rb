class FilmsAsiatiquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatique.save
        format.html { redirect_to _films_asiatique_url(@_films_asiatique), notice: "Films asiatique was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatique.update(_films_asiatique_params)
        format.html { redirect_to _films_asiatique_url(@_films_asiatique), notice: "Films asiatique was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_url, notice: "Films asiatique was successfully destroyed." }
