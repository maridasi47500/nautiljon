class DoujinshisAmsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_am.save
        format.html { redirect_to doujinshis_am_url(@_doujinshis_am), notice: "Doujinshis am was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_am.update(_doujinshis_am_params)
        format.html { redirect_to doujinshis_am_url(@_doujinshis_am), notice: "Doujinshis am was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to doujinshis_ams_url, notice: "Doujinshis am was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_am_params
      params.require(:doujinshis_am).permit(:name)
    end
end
