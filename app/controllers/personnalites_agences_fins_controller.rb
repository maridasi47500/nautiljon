class PersonnalitesAgencesFinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnalites_agences_fin.save
        format.html { redirect_to personnalites_agences_fin_url(@_personnalites_agences_fin), notice: "Personnalites agences fin was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnalites_agences_fin.update(_personnalites_agences_fin_params)
        format.html { redirect_to personnalites_agences_fin_url(@_personnalites_agences_fin), notice: "Personnalites agences fin was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to personnalites_agences_fins_url, notice: "Personnalites agences fin was successfully destroyed." }
  ...
  private
    ...
    def _personnalites_agences_fin_params
      params.require(:personnalites_agences_fin).permit(:name)
    end
end
