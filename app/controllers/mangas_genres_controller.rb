class MangasGenresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_genre.save
        format.html { redirect_to _mangas_genre_url(@_mangas_genre), notice: "Mangas genre was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_genre.update(_mangas_genre_params)
        format.html { redirect_to _mangas_genre_url(@_mangas_genre), notice: "Mangas genre was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_genres_url, notice: "Mangas genre was successfully destroyed." }
  ...
  private
    ...
    def _mangas_genre_params
      params.require(:_mangas_genre).permit(:name)
    end
end
