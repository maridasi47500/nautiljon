class FilmsAsiatiquesJvPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_jv_plu.save
        format.html { redirect_to films_asiatiques_jv_plu_url(@_films_asiatiques_jv_plu), notice: "Films asiatiques jv plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_jv_plu.update(_films_asiatiques_jv_plu_params)
        format.html { redirect_to films_asiatiques_jv_plu_url(@_films_asiatiques_jv_plu), notice: "Films asiatiques jv plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to films_asiatiques_jv_plus_url, notice: "Films asiatiques jv plu was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_jv_plu_params
      params.require(:films_asiatiques_jv_plu).permit(:name)
    end
end
