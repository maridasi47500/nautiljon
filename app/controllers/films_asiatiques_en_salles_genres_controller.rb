class FilmsAsiatiquesEnSallesGenresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_en_salles_genre.save
        format.html { redirect_to _films_asiatiques_en_salles_genre_url(@_films_asiatiques_en_salles_genre), notice: "Films asiatiques en salles genre was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_en_salles_genre.update(_films_asiatiques_en_salles_genre_params)
        format.html { redirect_to _films_asiatiques_en_salles_genre_url(@_films_asiatiques_en_salles_genre), notice: "Films asiatiques en salles genre was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_en_salles_genres_url, notice: "Films asiatiques en salles genre was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_en_salles_genre_params
      params.require(:_films_asiatiques_en_salles_genre).permit(:name)
    end
end
