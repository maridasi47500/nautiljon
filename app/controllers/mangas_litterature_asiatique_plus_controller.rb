class MangasLitteratureAsiatiquePlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_litterature_asiatique_plu.save
        format.html { redirect_to _mangas_litterature_asiatique_plu_url(@_mangas_litterature_asiatique_plu), notice: "Mangas litterature asiatique plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_litterature_asiatique_plu.update(_mangas_litterature_asiatique_plu_params)
        format.html { redirect_to _mangas_litterature_asiatique_plu_url(@_mangas_litterature_asiatique_plu), notice: "Mangas litterature asiatique plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_litterature_asiatique_plus_url, notice: "Mangas litterature asiatique plu was successfully destroyed." }
  ...
  private
    ...
    def _mangas_litterature_asiatique_plu_params
      params.require(:_mangas_litterature_asiatique_plu).permit(:name)
    end
end
