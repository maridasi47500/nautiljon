class DoujinshisDramaPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_drama_plu.save
        format.html { redirect_to doujinshis_drama_plu_url(@_doujinshis_drama_plu), notice: "Doujinshis drama plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_drama_plu.update(_doujinshis_drama_plu_params)
        format.html { redirect_to doujinshis_drama_plu_url(@_doujinshis_drama_plu), notice: "Doujinshis drama plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to doujinshis_drama_plus_url, notice: "Doujinshis drama plu was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_drama_plu_params
      params.require(:doujinshis_drama_plu).permit(:name)
    end
end
