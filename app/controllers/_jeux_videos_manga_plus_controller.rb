class JeuxVideosMangaPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_manga_plu.save
        format.html { redirect_to _jeux_videos_manga_plu_url(@_jeux_videos_manga_plu), notice: "Jeux videos manga plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_manga_plu.update(_jeux_videos_manga_plu_params)
        format.html { redirect_to _jeux_videos_manga_plu_url(@_jeux_videos_manga_plu), notice: "Jeux videos manga plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _jeux_videos_manga_plus_url, notice: "Jeux videos manga plu was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_manga_plu_params
      params.require(:_jeux_videos_manga_plu).permit(:name)
    end
end
