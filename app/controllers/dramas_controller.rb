class DramasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_drama.save
        format.html { redirect_to drama_url(@_drama), notice: "Drama was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_drama.update(_drama_params)
        format.html { redirect_to drama_url(@_drama), notice: "Drama was successfully updated." }
