class ConcertsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_concert.save
        format.html { redirect_to concert_url(@_concert), notice: "Concert was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_concert.update(_concert_params)
        format.html { redirect_to concert_url(@_concert), notice: "Concert was successfully updated." }
  ...
  private
    ...
    def _concert_params
      params.require(:concert).permit(:date, :_concerts_artiste_id, :nom, :endroit, :adresse, :ville, :_concerts_pays_id, :infos, :lien, :prix, :heure, :acceptregles)
    end
end
