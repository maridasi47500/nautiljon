class JeuxVideosDoujinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_doujin.save
        format.html { redirect_to _jeux_videos_doujin_url(@_jeux_videos_doujin), notice: "Jeux videos doujin was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_doujin.update(_jeux_videos_doujin_params)
        format.html { redirect_to _jeux_videos_doujin_url(@_jeux_videos_doujin), notice: "Jeux videos doujin was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _jeux_videos_doujins_url, notice: "Jeux videos doujin was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_doujin_params
      params.require(:_jeux_videos_doujin).permit(:name)
    end
end
