class DoujinshisAnimePlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_doujinshis_anime_plu.save
        format.html { redirect_to doujinshis_anime_plu_url(@_doujinshis_anime_plu), notice: "Doujinshis anime plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_doujinshis_anime_plu.update(_doujinshis_anime_plu_params)
        format.html { redirect_to doujinshis_anime_plu_url(@_doujinshis_anime_plu), notice: "Doujinshis anime plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to doujinshis_anime_plus_url, notice: "Doujinshis anime plu was successfully destroyed." }
  ...
  private
    ...
    def _doujinshis_anime_plu_params
      params.require(:doujinshis_anime_plu).permit(:name)
    end
end
