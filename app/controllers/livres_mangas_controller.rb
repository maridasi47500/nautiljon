class LivresMangasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_livres_manga.save
        format.html { redirect_to _livres_manga_url(@_livres_manga), notice: "Livres manga was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_livres_manga.update(_livres_manga_params)
        format.html { redirect_to _livres_manga_url(@_livres_manga), notice: "Livres manga was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _livres_mangas_url, notice: "Livres manga was successfully destroyed." }
  ...
  private
    ...
    def _livres_manga_params
      params.require(:_livres_manga).permit(:name)
    end
end
