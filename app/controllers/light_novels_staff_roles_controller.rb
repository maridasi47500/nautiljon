class LightNovelsStaffRolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_light_novels_staff_role.save
        format.html { redirect_to light_novels_staff_role_url(@_light_novels_staff_role), notice: "Light novels staff role was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_light_novels_staff_role.update(_light_novels_staff_role_params)
        format.html { redirect_to light_novels_staff_role_url(@_light_novels_staff_role), notice: "Light novels staff role was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to light_novels_staff_roles_url, notice: "Light novels staff role was successfully destroyed." }
  ...
  private
    ...
    def _light_novels_staff_role_params
      params.require(:light_novels_staff_role).permit(:name)
    end
end
