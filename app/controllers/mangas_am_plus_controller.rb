class MangasAmPlusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_am_plu.save
        format.html { redirect_to _mangas_am_plu_url(@_mangas_am_plu), notice: "Mangas am plu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_am_plu.update(_mangas_am_plu_params)
        format.html { redirect_to _mangas_am_plu_url(@_mangas_am_plu), notice: "Mangas am plu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_am_plus_url, notice: "Mangas am plu was successfully destroyed." }
  ...
  private
    ...
    def _mangas_am_plu_params
      params.require(:_mangas_am_plu).permit(:name)
    end
end
