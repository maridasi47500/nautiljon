class GeneriqueDeJeuVideosStaffRolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_generique_de_jeu_videos_staff_role.save
        format.html { redirect_to generique_de_jeu_videos_staff_role_url(@_generique_de_jeu_videos_staff_role), notice: "Generique de jeu videos staff role was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_generique_de_jeu_videos_staff_role.update(_generique_de_jeu_videos_staff_role_params)
        format.html { redirect_to generique_de_jeu_videos_staff_role_url(@_generique_de_jeu_videos_staff_role), notice: "Generique de jeu videos staff role was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to generique_de_jeu_videos_staff_roles_url, notice: "Generique de jeu videos staff role was successfully destroyed." }
  ...
  private
    ...
    def _generique_de_jeu_videos_staff_role_params
      params.require(:generique_de_jeu_videos_staff_role).permit(:name)
    end
end
