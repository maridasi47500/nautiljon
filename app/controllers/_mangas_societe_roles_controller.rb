class MangasSocieteRolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_societe_role.save
        format.html { redirect_to _mangas_societe_role_url(@_mangas_societe_role), notice: "Mangas societe role was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_societe_role.update(_mangas_societe_role_params)
        format.html { redirect_to _mangas_societe_role_url(@_mangas_societe_role), notice: "Mangas societe role was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _mangas_societe_roles_url, notice: "Mangas societe role was successfully destroyed." }
  ...
  private
    ...
    def _mangas_societe_role_params
      params.require(:_mangas_societe_role).permit(:name)
    end
end
