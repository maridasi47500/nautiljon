class FilmsAsiatiquesEmissionTvsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_films_asiatiques_emission_tv.save
        format.html { redirect_to _films_asiatiques_emission_tv_url(@_films_asiatiques_emission_tv), notice: "Films asiatiques emission tv was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_films_asiatiques_emission_tv.update(_films_asiatiques_emission_tv_params)
        format.html { redirect_to _films_asiatiques_emission_tv_url(@_films_asiatiques_emission_tv), notice: "Films asiatiques emission tv was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _films_asiatiques_emission_tvs_url, notice: "Films asiatiques emission tv was successfully destroyed." }
  ...
  private
    ...
    def _films_asiatiques_emission_tv_params
      params.require(:_films_asiatiques_emission_tv).permit(:name)
    end
end
