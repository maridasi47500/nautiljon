class JeuxVideosJvsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_jv.save
        format.html { redirect_to jeux_videos_jv_url(@_jeux_videos_jv), notice: "Jeux videos jv was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_jv.update(_jeux_videos_jv_params)
        format.html { redirect_to jeux_videos_jv_url(@_jeux_videos_jv), notice: "Jeux videos jv was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to jeux_videos_jvs_url, notice: "Jeux videos jv was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_jv_params
      params.require(:jeux_videos_jv).permit(:name)
    end
end
