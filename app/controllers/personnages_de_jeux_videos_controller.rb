class PersonnagesDeJeuxVideosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_personnages_de_jeux_video.save
        format.html { redirect_to _personnages_de_jeux_video_url(@_personnages_de_jeux_video), notice: "Personnages de jeux video was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_personnages_de_jeux_video.update(_personnages_de_jeux_video_params)
        format.html { redirect_to _personnages_de_jeux_video_url(@_personnages_de_jeux_video), notice: "Personnages de jeux video was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _personnages_de_jeux_videos_url, notice: "Personnages de jeux video was successfully destroyed." }
