class JeuxVideosCulturesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_culture.save
        format.html { redirect_to _jeux_videos_culture_url(@_jeux_videos_culture), notice: "Jeux videos culture was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_culture.update(_jeux_videos_culture_params)
        format.html { redirect_to _jeux_videos_culture_url(@_jeux_videos_culture), notice: "Jeux videos culture was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _jeux_videos_cultures_url, notice: "Jeux videos culture was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_culture_params
      params.require(:_jeux_videos_culture).permit(:name)
    end
end
