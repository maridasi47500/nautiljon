class GoodiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_goody.save
        format.html { redirect_to _goody_url(@_goody), notice: "Goody was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_goody.update(_goody_params)
        format.html { redirect_to _goody_url(@_goody), notice: "Goody was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _goodies_url, notice: "Goody was successfully destroyed." }
