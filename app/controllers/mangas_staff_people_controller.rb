class MangasStaffPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_mangas_staff_person.save
        format.html { redirect_to mangas_staff_person_url(@_mangas_staff_person), notice: "Mangas staff person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_mangas_staff_person.update(_mangas_staff_person_params)
        format.html { redirect_to mangas_staff_person_url(@_mangas_staff_person), notice: "Mangas staff person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mangas_staff_people_url, notice: "Mangas staff person was successfully destroyed." }
  ...
  private
    ...
    def _mangas_staff_person_params
      params.require(:mangas_staff_person).permit(:name)
    end
end
