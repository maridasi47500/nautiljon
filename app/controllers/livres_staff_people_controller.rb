class LivresStaffPeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_livres_staff_person.save
        format.html { redirect_to livres_staff_person_url(@_livres_staff_person), notice: "Livres staff person was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_livres_staff_person.update(_livres_staff_person_params)
        format.html { redirect_to livres_staff_person_url(@_livres_staff_person), notice: "Livres staff person was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to livres_staff_people_url, notice: "Livres staff person was successfully destroyed." }
  ...
  private
    ...
    def _livres_staff_person_params
      params.require(:livres_staff_person).permit(:name)
    end
end
