class BrevesLitteratureAsiatiquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_breves_litterature_asiatique.save
        format.html { redirect_to _breves_litterature_asiatique_url(@_breves_litterature_asiatique), notice: "Breves litterature asiatique was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_breves_litterature_asiatique.update(_breves_litterature_asiatique_params)
        format.html { redirect_to _breves_litterature_asiatique_url(@_breves_litterature_asiatique), notice: "Breves litterature asiatique was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _breves_litterature_asiatiques_url, notice: "Breves litterature asiatique was successfully destroyed." }
  ...
  private
    ...
    def _breves_litterature_asiatique_params
      params.require(:_breves_litterature_asiatique).permit(:name)
    end
end
