class JeuxVideosDvdsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_jeux_videos_dvd.save
        format.html { redirect_to jeux_videos_dvd_url(@_jeux_videos_dvd), notice: "Jeux videos dvd was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_jeux_videos_dvd.update(_jeux_videos_dvd_params)
        format.html { redirect_to jeux_videos_dvd_url(@_jeux_videos_dvd), notice: "Jeux videos dvd was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to jeux_videos_dvds_url, notice: "Jeux videos dvd was successfully destroyed." }
  ...
  private
    ...
    def _jeux_videos_dvd_params
      params.require(:jeux_videos_dvd).permit(:name)
    end
end
