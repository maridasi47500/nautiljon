class DramasGeneriquesTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @_dramas_generiques_type.save
        format.html { redirect_to _dramas_generiques_type_url(@_dramas_generiques_type), notice: "Dramas generiques type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @_dramas_generiques_type.update(_dramas_generiques_type_params)
        format.html { redirect_to _dramas_generiques_type_url(@_dramas_generiques_type), notice: "Dramas generiques type was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to _dramas_generiques_types_url, notice: "Dramas generiques type was successfully destroyed." }
  ...
  private
    ...
    def _dramas_generiques_type_params
      params.require(:_dramas_generiques_type).permit(:name)
    end
end
